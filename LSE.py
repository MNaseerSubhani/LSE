    ...
    def train_adp(self,round_):
        ...
        for i in range(start_iter, self.args.num_steps):
            ...
            if (i+1) % self.args.saving_step == 0 :
                ...
                torch.save(self.model.state_dict(), os.path.join(self.args.snapshot_dir, '%s_' %(self.args.source+"_to_" +self.args.target) +'.pth' ))   
...
if __name__ == "__main__":
    ...
    for round_ in range(Rounds):
        ...
        testing_entr, mIoU_ = evaluation.main(Base.model)
